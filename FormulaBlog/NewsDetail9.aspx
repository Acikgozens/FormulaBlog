<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewsDetail9.aspx.cs" Inherits="FormulaBlog.NewsDetail9" %>
...
<body>
    <form runat="server">
        ...
        <div class="container mt-5">
            <div class="card mb-3">
                <img src="https://cdn-4.motorsport.com/images/mgl/6gpAgda0/s400/lewis-hamilton-mercedes-amg-2n-1.webp" class="card-img-top" style="height:400px" alt=" ">
                <div class="card-body">
                    <h5 class="card-title font-weight-bold">Sebastian Vettel Emekli</h5>
                    <p class="card-text">
