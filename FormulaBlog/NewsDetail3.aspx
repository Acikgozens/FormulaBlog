<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewsDetail3.aspx.cs" Inherits="FormulaBlog.NewsDetail3" %>
...
<body>
    <form runat="server">
        ...
        <div class="container mt-5">
            <div class="card mb-3">
                <img src="https://cdn-9.motorsport.com/images/mgl/Yv85ymE0/s400/fernando-alonso-aston-martin-f-1.webp" class="card-img-top" style="height:400px" alt=" ">
                <div class="card-body">
                    <h5 class="card-title font-weight-bold">Sebastin Vettel Emekli</h5>
                    <p class="card-text">
